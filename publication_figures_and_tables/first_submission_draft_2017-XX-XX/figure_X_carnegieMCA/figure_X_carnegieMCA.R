...
#Q1
data.relavant$Q1_Please.select.the.statement.belOw.that.best.describes.yOur.current.teaching.Of.biOinfOrmatics.cOn...[data.relavant$Q1_Please.select.the.statement.belOw.that.best.describes.yOur.current.teaching.Of.biOinfOrmatics.cOn... == "1_Dedicated course for life-science majors"] <- "Teaching:\nDedicated Course"
data.relavant$Q1_Please.select.the.statement.belOw.that.best.describes.yOur.current.teaching.Of.biOinfOrmatics.cOn...[data.relavant$Q1_Please.select.the.statement.belOw.that.best.describes.yOur.current.teaching.Of.biOinfOrmatics.cOn... == "2_Include 'substantial' bioinformatics in courses for life-science majors"  ] <- "Teaching:\nIntegrating"
...
#23
data.relavant$Q23_What.is.the.total.number.of.students..undergraduate.and.graduate..at.your.institution.[data.relavant$Q23_What.is.the.total.number.of.students..undergraduate.and.graduate..at.your.institution. == "1_'< 5,000' student'" ] <- "Total Students:\n<5,000"
data.relavant$Q23_What.is.the.total.number.of.students..undergraduate.and.graduate..at.your.institution.[data.relavant$Q23_What.is.the.total.number.of.students..undergraduate.and.graduate..at.your.institution. == "2_'5,000 - 15,000' students"  ] <- "Total Students:\n5-15,000"
data.relavant$Q23_What.is.the.total.number.of.students..undergraduate.and.graduate..at.your.institution.[data.relavant$Q23_What.is.the.total.number.of.students..undergraduate.and.graduate..at.your.institution. == "3_'> 15,000' students"  ] <- "Total Students:\n>15,000"
...
#24
data.relavant$Q24_What.is.the.total.number.of.undergraduate.students.at.your.institution.[data.relavant$Q24_What.is.the.total.number.of.undergraduate.students.at.your.institution. == "1_'< 5,000' students" ] <- "Total Undergraduates:\n<5,000"
data.relavant$Q24_What.is.the.total.number.of.undergraduate.students.at.your.institution.[data.relavant$Q24_What.is.the.total.number.of.undergraduate.students.at.your.institution. == "2_'5,000 - 15,000' students" ] <- "Total Undergraduates:\n5-15,000"
data.relavant$Q24_What.is.the.total.number.of.undergraduate.students.at.your.institution.[data.relavant$Q24_What.is.the.total.number.of.undergraduate.students.at.your.institution. == "3_'> 15,000' students"  ] <- "Total Undergraduates:\n>15,000"
...
fviz_mca_biplot(MCA.object,
                ...
                repel = TRUE,
                labelsize = 6,
                legend.title = "Respondents Grouped by\nCarnegie classification (ellipse = 80%)\n",
                ellipse.level = 0.80)+
  #theme_minimal()+
...
ggsave(filename = "Q21_carnegie_classification.png", 
       width = 13.8, 
       height = 8.81, 
       units = "in")

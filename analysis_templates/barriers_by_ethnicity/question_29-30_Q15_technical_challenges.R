...
category.df <- data.frame ("American Indian or Alaskan Native"= category.levels[1],
                           "Asian" = category.levels[2], 
                           "Black or African American" = category.levels[3], 
                           "Hispanic" = category.levels[4],
                           "Native Hawaiian or Pacific Islander"= category.levels[5], 
...
############## Rerun analysis comparing Underrepresented VS non-underrepresented
...
category.df <- data.frame ("Not underrepresented in STEM"= category.levels[1],
                           "Underrepresented in STEM" = category.levels[2], 
                           stringsAsFactors = FALSE)

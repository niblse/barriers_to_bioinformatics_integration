...
#(e.g. gender, institution type): "Minority-Serving"

category.nice.name.caps <- "Minority-Serving"
category.nice.name.lower <- "minority-serving"
...
category.df <- data.frame ("Minority-Serving"= category.levels[1],
                           "Non-Minority-Serving"= category.levels[2],  
                           stringsAsFactors = FALSE)

...
category.df <- data.frame ("No Training"= category.levels[1],
                           "Self-taught"= category.levels[2], 
                           "Short workshops"= category.levels[3], 
                           "Some undergraduate coursework"= category.levels[4], 
                           "Undergraduate certificate"= category.levels[5], 
                           "Undergraduate degree"= category.levels[6], 
                           "Post-graduate certificate"= category.levels[7], 
                           "Graduate course or degree"= category.levels[8], 
                           stringsAsFactors = FALSE)

...
#Respondant ID (index), annomized email address, IP, Q57, Q1, Q38
#[1:6]


#Q38 numerical sums of coded categories alternating with binary score (0 or 1) for coded super-categories (1 indicated a response in any sub-catagory)
#summed/reduced(binary) columns begin with lowercase 'q' followed by question number and unscore: 8 super-catagories, 16 summary rows (8 sums, 8 reductions)
#[7:22]
...
#Q6 numerical sums of coded categories alternating with binary score (0 or 1) for coded super-categories (1 indicated a response in any sub-catagory)
#summed/reduced(binary) columns begin with lowercase 'q' followed by question number and unscore: 6 super-catagories, 12 summary rows (6 sums, 6 reductions)
#[59:70]
...
#Q8, Q10, Q54-55, Q43, Q43, Q59, Q29-30
#[99:107]

#Q29-30 numerical sums of coded categories alternating with binary score (0 or 1) for coded super-categories (1 indicated a response in any sub-catagory)
#summed/reduced(binary) columns begin with lowercase 'q' followed by question number and unscore: 6 super-catagories, 12 summary rows (6 sums, 6 reductions)
#[108:119]


#Q29-30 coded responses
#[120:147]


# Q14-18, Q3, Q21-28, Q33
#[148:163]

#Q33 numerical sums of coded categories alternating with binary score (0 or 1) for coded super-categories (1 indicated a response in any sub-catagory)
#summed/reduced(binary) columns begin with lowercase 'q' followed by question number and unscore: 6 super-catagories, 12 summary rows (6 sums, 6 reductions)
#[164:175]
...
#Q41 numerical sums of coded categories alternating with binary score (0 or 1) for coded super-categories (1 indicated a response in any sub-catagory)
#summed/reduced(binary) columns begin with lowercase 'q' followed by question number and unscore: 1 super-catagories, 2 summary rows (1 sums, 1 reductions)
#[208:209]
...
#Q35, City, State, Country, Region, Division
#[237-242]
